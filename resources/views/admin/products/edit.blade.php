                            ...
                            <section>
                                <div class="container">
                                    <div class="add">
                                        ...
                                        @endif
                                        <form class="m-2" action="{{ route('products.update',$product->id) }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label for="sp">Name product</label>
                                                <input type="text " name="name" value="{{ $product->name }}" class="
                                                    form-control" id="sp">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text " name="description"
                                                    value="{{ $product->description }}" class="form-control" id="sp">
                                            </div>

                                            <button type="submit" class="btn btn-success "
                                                style="font-size: 18;padding: 5px;">edit</button>
                                        </form>
